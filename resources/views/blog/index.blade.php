                        ...
                        <div class="banner-carousel">
                            ...
                            <div class="banner-item">
                                ...
                                <div class="banner-text">
                                    ...
                                    <p class="mb-3">{{substr($post->content,0,200)}}{{strlen($post->content) > 200 ? "..." : ""}}</p>
                                    <a href="{{url('single_post/'.$post->id)}}" class="btn btn-solid btn-read">Read More</a>
                                </div>
                            </div>
                            @endforeach
{{--                            <div class="banner-item">--}}
            ...
            <div class="more-content-grid py-30">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="#">
                                <img src="assets/images/bus.jpg" class="card-img-top " alt="" />
                            </a>
...
{{--                        <div class="card">--}}
{{--                            <a href="single-layout-one.html">--}}
{{--                                <img src="assets/images/roaming.jpg" class="card-img-top " alt="" />--}}
{{--                            </a>--}}
...
{{--                        <div class="card">--}}
{{--                            <a href="single-layout-one.html">--}}
{{--                                <img src="assets/images/paris.jpg" class="card-img-top " alt="" />--}}
{{--                            </a>--}}
            ...
            <div class="row">
                <div class="col-md-12 col-lg-7">
                    <div class="featured-left">
                        ...
                        <div class="card">
                            <a href="#"><img src="assets/images/girl.jpg" class="card-img " alt="" /></a>
                ...
                <div class="col-md-12 col-lg-5">
                    <div class="featured-right">
                        ...
                        <div class="card">
                            <a href="#">
                                <img src="assets/images/umbrella.jpg" class="card-img-top " alt="">
                            </a>
                            <div class="card-body">
                                <ul class="category-tag-list">
                                ...
                                <h5 class="card-title title-font"><a href="#">
                                        {{$post->metaTitle}}</a>
                                </h5>
                                <div class="author-date">
                                    <a class="author" href="#">
            ...
            <div class="row">
                <div class="col-md-7 col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"> <img src="assets/images/alone-house.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"><img src="assets/images/taj.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"><img src="assets/images/camera.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
            ...
            <div class="more-content-grid ">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="assets/images/lights.jpg" class="card-img-top" alt="" />
                            </a>
                            <div class="card-body px-0">
                                <ul class="category-tag-list">
                                    <li class="category-tag-name">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="assets/images/lighthouse.jpg" class="card-img-top" alt="" />
                            </a>
                            <div class="card-body px-0">
                                <ul class="category-tag-list">
                                    <li class="category-tag-name">
