            ...
            <ul class="nav-menu ml-auto mr-auto" id="nav-menu-toggle">
                ...
                <li class="nav-item"><a href="#" class="nav-link">Categories <span class="arrow-icon"> <span
                  ...
                  <span class="right-bar"></span></span>
                    ...
                    <ul class="drop-menu">
                        <li class="drop-menu-item"><a href="all_categories">Food</a></li>
                        <li class="drop-menu-item"><a href="all_posts">Technology</a></li>
{{--                        <li class="drop-menu-item"><a href="#">Fashion</a></li>--}}
{{--                        <li class="drop-menu-item"><a href="#">Women</a></li>--}}
{{--                        <li class="drop-menu-item"><a href="#">Lifestyle</a></li>--}}
                    </ul>
                </li>
                <li class="nav-item drop-arrow"><a href="#" class="nav-link">Recent <span class="arrow-icon"> <span
                                class="left-bar"></span>
                  <span class="right-bar"></span></span></a>
                    <ul class="drop-menu">
                        <li class="drop-menu-item"><a href="post">Popular posts</a></li>
                        <li class="drop-menu-item"><a href="authors">Popular authors</a></li>
...
{{--                        <li class="drop-menu-item"><a href="search.html">Search Page</a></li>--}}
                ...
                <li class="nav-item drop-arrow"><a href="#" class="nav-link">More <span class="arrow-icon"> <span
                                class="left-bar"></span>
                  <span class="right-bar"></span></span></a>
                    <ul class="drop-menu">
                        <li class="drop-menu-item"><a href="register">Join our blog</a></li>
                        <li class="drop-menu-item"><a href="authors">Authors</a></li>
                        <li class="drop-menu-item"><a href="archives">Archives</a></li>
                        <li class="drop-menu-item"><a href="dark_mode">Dark mode</a></li>
